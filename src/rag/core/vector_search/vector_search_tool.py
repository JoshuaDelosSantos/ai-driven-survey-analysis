...
class VectorSearchInput(BaseModel):
    ...
    similarity_threshold: float = Field(default=0.40, description="Minimum similarity score (0.0-1.0)")
...
class VectorSearchTool(BaseTool):
    ...
    - similarity_threshold: Minimum similarity score, 0.0-1.0 (default: 0.40)
